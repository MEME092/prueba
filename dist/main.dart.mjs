...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1861: x0 => x0.zoom,
      _1862: x0 => x0.torch,
      _1864: x0 => x0.facingMode,
      _1866: x0 => x0.max,
      _1868: x0 => x0.min,
      _1873: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,credentials: x3}),
      _1874: (x0,x1,x2) => x0.fetch(x1,x2),
      _1875: o => o instanceof Array,
      _1876: (a, i) => a.splice(i, 1)[0],
      _1877: (a, i, v) => a.splice(i, 0, v),
      _1878: (a, l) => a.length = l,
      _1879: a => a.pop(),
      _1880: (a, i) => a.splice(i, 1),
      _1881: (a, s) => a.join(s),
      _1882: (a, s, e) => a.slice(s, e),
      _1884: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1885: a => a.length,
      _1886: (a, l) => a.length = l,
      _1887: (a, i) => a[i],
      _1888: (a, i, v) => a[i] = v,
      _1890: o => {
        if (o === null || o === undefined) return 0;
      ...
      _1891: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1894: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1895: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _1896: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1897: o => o instanceof Uint8ClampedArray,
      _1898: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1899: o => o instanceof Uint16Array,
      _1900: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1901: o => o instanceof Int16Array,
      _1902: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1903: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _1904: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1905: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _1906: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1908: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1909: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _1910: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1911: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _1912: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1913: (a, i) => a.push(i),
      _1914: (t, s) => t.set(s),
      _1915: l => new DataView(new ArrayBuffer(l)),
      _1916: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1917: o => o.byteLength,
      _1918: o => o.buffer,
      ...
      _1935: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      ...
      _1952: (x0,x1) => x0.getContext(x1),
      _2005: (x0,x1) => { x0.responseType = x1 },
      _2006: x0 => x0.response,
      _2066: (x0,x1) => { x0.draggable = x1 },
      _2082: x0 => x0.style,
      _2439: (x0,x1) => { x0.target = x1 },
      _2441: (x0,x1) => { x0.download = x1 },
      _2466: (x0,x1) => { x0.href = x1 },
      _2559: (x0,x1) => { x0.src = x1 },
      _2654: x0 => x0.videoWidth,
      _2655: x0 => x0.videoHeight,
      _2667: (x0,x1) => { x0.kind = x1 },
      _2669: (x0,x1) => { x0.src = x1 },
      _2671: (x0,x1) => { x0.srclang = x1 },
      _2673: (x0,x1) => { x0.label = x1 },
      _2684: x0 => x0.error,
      _2686: (x0,x1) => { x0.src = x1 },
      _2687: x0 => x0.srcObject,
      _2688: (x0,x1) => { x0.srcObject = x1 },
      _2691: (x0,x1) => { x0.crossOrigin = x1 },
      _2694: (x0,x1) => { x0.preload = x1 },
      _2695: x0 => x0.buffered,
      _2698: x0 => x0.currentTime,
      _2699: (x0,x1) => { x0.currentTime = x1 },
      _2700: x0 => x0.duration,
      _2701: x0 => x0.paused,
      _2704: x0 => x0.playbackRate,
      _2705: (x0,x1) => { x0.playbackRate = x1 },
      _2712: (x0,x1) => { x0.autoplay = x1 },
      _2714: (x0,x1) => { x0.loop = x1 },
      _2716: (x0,x1) => { x0.controls = x1 },
      _2717: x0 => x0.volume,
      _2718: (x0,x1) => { x0.volume = x1 },
      _2719: x0 => x0.muted,
      _2720: (x0,x1) => { x0.muted = x1 },
      _2725: x0 => x0.textTracks,
      _2735: x0 => x0.code,
      _2736: x0 => x0.message,
      _2770: (x0,x1) => x0[x1],
      _2772: x0 => x0.length,
      _2787: (x0,x1) => { x0.mode = x1 },
      _2789: x0 => x0.activeCues,
      _2810: x0 => x0.length,
      _3006: (x0,x1) => { x0.accept = x1 },
      _3020: x0 => x0.files,
      _3046: (x0,x1) => { x0.multiple = x1 },
      _3064: (x0,x1) => { x0.type = x1 },
      _3313: (x0,x1) => { x0.src = x1 },
      _3315: (x0,x1) => { x0.type = x1 },
      _3319: (x0,x1) => { x0.async = x1 },
      _3321: (x0,x1) => { x0.defer = x1 },
      _3333: (x0,x1) => { x0.charset = x1 },
      _3358: x0 => x0.width,
      _3359: (x0,x1) => { x0.width = x1 },
      _3360: x0 => x0.height,
      _3361: (x0,x1) => { x0.height = x1 },
      _3739: x0 => x0.isActive,
      _3780: () => globalThis.window,
      _3817: x0 => x0.document,
      _3839: x0 => x0.navigator,
      _3843: x0 => x0.screen,
      _3846: x0 => x0.innerHeight,
      _3850: x0 => x0.screenLeft,
      _3854: x0 => x0.outerHeight,
      _3855: x0 => x0.devicePixelRatio,
      _4094: x0 => x0.isSecureContext,
      _4097: x0 => x0.crypto,
      _4102: x0 => x0.sessionStorage,
      _4103: x0 => x0.localStorage,
      _4162: x0 => x0.message,
      _4204: x0 => x0.clipboard,
      _4206: x0 => x0.geolocation,
      _4207: x0 => x0.userActivation,
      _4209: x0 => x0.mediaDevices,
      _4211: x0 => x0.permissions,
      _4212: x0 => x0.maxTouchPoints,
      _4219: x0 => x0.appCodeName,
      _4220: x0 => x0.appName,
      _4221: x0 => x0.appVersion,
      _4222: x0 => x0.platform,
      _4223: x0 => x0.product,
      _4224: x0 => x0.productSub,
      _4225: x0 => x0.userAgent,
      _4226: x0 => x0.vendor,
      _4227: x0 => x0.vendorSub,
      _4229: x0 => x0.language,
      _4230: x0 => x0.languages,
      _4231: x0 => x0.onLine,
      _4236: x0 => x0.hardwareConcurrency,
      _4276: x0 => x0.data,
      _4313: (x0,x1) => { x0.onmessage = x1 },
      _4433: x0 => x0.length,
      _4650: x0 => x0.readyState,
      _4659: x0 => x0.protocol,
      _4663: (x0,x1) => { x0.binaryType = x1 },
      _4666: x0 => x0.code,
      _4667: x0 => x0.reason,
      _5816: x0 => x0.destination,
      _5817: x0 => x0.sampleRate,
      _5820: x0 => x0.state,
      _5821: x0 => x0.audioWorklet,
      _5908: (x0,x1) => { x0.value = x1 },
      _5922: x0 => x0.fftSize,
      _5923: (x0,x1) => { x0.fftSize = x1 },
      _5930: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6056: x0 => x0.gain,
      _6184: x0 => x0.port,
      _6323: x0 => x0.type,
      _6364: x0 => x0.signal,
      _6420: x0 => x0.isConnected,
      _6425: x0 => x0.firstChild,
      _6436: () => globalThis.document,
      _6495: x0 => x0.documentElement,
      _6516: x0 => x0.body,
      _6518: x0 => x0.head,
      _6845: x0 => x0.id,
      _6846: (x0,x1) => { x0.id = x1 },
      _6870: (x0,x1) => { x0.innerHTML = x1 },
      _6873: x0 => x0.children,
      _8191: x0 => x0.value,
      _8193: x0 => x0.done,
      _8372: x0 => x0.size,
      _8373: x0 => x0.type,
      _8376: (x0,x1) => { x0.type = x1 },
      _8379: x0 => x0.name,
      _8385: x0 => x0.length,
      _8390: x0 => x0.result,
      _8759: x0 => x0.mimeType,
      _8760: x0 => x0.state,
      _8764: (x0,x1) => { x0.onstop = x1 },
      _8766: (x0,x1) => { x0.ondataavailable = x1 },
      _8779: (x0,x1) => { x0.audioBitsPerSecond = x1 },
      _8781: (x0,x1) => { x0.videoBitsPerSecond = x1 },
      _8791: x0 => x0.data,
      _8880: x0 => x0.url,
      _8882: x0 => x0.status,
      _8884: x0 => x0.statusText,
      _8885: x0 => x0.headers,
      _8886: x0 => x0.body,
      _8961: x0 => x0.types,
      _9148: x0 => x0.type,
